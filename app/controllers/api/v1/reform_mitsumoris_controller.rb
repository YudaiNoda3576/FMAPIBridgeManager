...
class Api::V1::ReformMitsumorisController < Api::V1::ApplicationController
  ...
  def reform_mitsumori_params
    params.require(:data).permit(:record_id, :pref, :city, :cho, :addr, :name, :tel, :building_type, :contact_remark, :budget, :building_age, :building_age, :email, :mitsumori, point: [], contact_time: [])
  ...
  def update_params(data)
    {
      ...
      construction_type: reform_mitsumori_params[:point].join(",") || data.construction_type,
